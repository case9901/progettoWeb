<!--1) Lista prodotti-> al posto di compra, c'è modifica, vedi e elimina. Nel profilo si aggiunge opzione aggiungi prodotto
 2)User page rimane uguale, ma ordini sono tutti gli ordini, e notifiche sono date da assenza o presenza di prodotti piu nuovi ordini. 
 3) ce 1 solo admin -->
 <section class="section-padding">

<div class="container">
<div class="col-12 text-center">
    <h2 class="mb-5">I nostri prodotti</h2>
  </div>
